...
$query = "UPDATE records SET beneficiary='$beneficiary', amount='$amount', description='$description', entrydate='$entrydate', forecastdate='$forecast' WHERE id='$id'";
 mysqli_query($dbc, $query) or die(mysqli_error($dbc));
       //Load composer's autoloader
            ...
            $q = "SELECT * FROM users WHERE role='supervisor' AND unit='IT'";
...
try {
   ...
   $mail->SMTPAuth = true;                               // Enable SMTP authentication
    ...
    $mail->Body    = "<h4>Hello,</h4> 
                    <br /> 
                    An Update has occurred on the Finance System. It was carried out by  ".$_SESSION['sup_name'].",  Check the System for More details <br />Cheers";
