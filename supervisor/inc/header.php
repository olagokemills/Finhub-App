...
<head>
    ...
    <title>Supervisors | Dashboard</title>
        ...
        <div class="navbar-header">
            ...
            <form role="search" class="navbar-form-custom">
                <div class="form-group">
                    <input type="text" hidden="" class="form-control" name="top-search" id="top-search">
                </div>
            </form>
        </div>
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-danger welcome-message">  <?php echo $_SESSION['sup_name']; ?></span>
                </li>
