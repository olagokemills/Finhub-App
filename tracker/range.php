            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title" height="200px !important">';   
                       ...
                       echo '<h5>Showing Records From '. (isset($_POST['range'])? $from .' to '. $to : 'Select Your Range'  ).' From <span class="text-danger">'.$unit.' </span>Unit</h5>';
                       echo'
                    </div>
                    ...
                    <tbody>';
                              $query = "SELECT * FROM records WHERE unit = '$unit'AND forecastdate BETWEEN '$from' AND '$to'";
