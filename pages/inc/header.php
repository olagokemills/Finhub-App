    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li>
                         ...
                         <li>
                            <a href="add_records.php">Add Record</a>
                        </li>
                    </ul>
                </li>
                 ...
                 <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li>
                         ...
                         <li>
                            <a href="add_user.php">Create Users</a>
                ...
                <li>
                    <a href="#"><i class="fa fa-magic"></i> <span class="nav-label">Admin </span><span class="label label-info pull-right"></span></a>
                </li>
                
                <li class="special_link">
                    <a ><i class="fa fa-database"></i> <span class="nav-label">Activities</span></a>
                </li>
            </ul>
        ...
        <div class="navbar-header">
            ...
            <form role="search" class="navbar-form-custom" action="https://chuibility.github.io/inspinia/search_results.html">
                <div class="form-group">
                    <input type="hidden" placeholder="Search for something..." hidden="" class="form-control" name="top-search" id="top-search">
                </div>
            </form>
        </div>
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message"><?php echo $_SESSION['admin_username']?></span>
                </li>
